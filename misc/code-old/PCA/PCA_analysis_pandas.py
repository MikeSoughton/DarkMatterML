...
df_BG = pd.read_csv('modified_smfulldelphes.csv')
df_ALP = pd.read_csv('modified_alpfulldelphes.csv')
df_EFT = pd.read_csv('modified_spin1meddelphes.csv')
df_SUSY1 = pd.read_csv('modified_susyfulldelphes1.csv')
df_SUSY2 = pd.read_csv('modified_susyfulldelphes2.csv')
df_SUSY3 = pd.read_csv('modified_susyfulldelphes3.csv')
