...
BG_ptj1,BG_ptj2,BG_etaj1,BG_etaj2,BG_phij,BG_MET,BG_met_phi,BG_metphij1,BG_metphij2,BG_signal=np.loadtxt("smfulldelphes.csv", unpack=True,skiprows=1)
ALP_ptj1,ALP_ptj2,ALP_etaj1,ALP_etaj2,ALP_phij,ALP_MET,ALP_met_phi,ALP_metphij1,ALP_metphij2,ALP_signal=np.loadtxt("alpfulldelphes.csv", unpack=True,skiprows=1)
EFT_ptj1,EFT_ptj2,EFT_etaj1,EFT_etaj2,EFT_phij,EFT_MET,EFT_met_phi,EFT_metphij1,EFT_metphij2,EFT_signal=np.loadtxt("spin1meddelphes.csv", unpack=True,skiprows=1)
SUSY1_ptj1,SUSY1_ptj2,SUSY1_etaj1,SUSY1_etaj2,SUSY1_phij,SUSY1_MET,SUSY1_met_phi,SUSY1_metphij1,SUSY1_metphij2,SUSY1_signal=np.loadtxt("susyfulldelphes1.csv", unpack=True,skiprows=1)
SUSY2_ptj1,SUSY2_ptj2,SUSY2_etaj1,SUSY2_etaj2,SUSY2_phij,SUSY2_MET,SUSY2_met_phi,SUSY2_metphij1,SUSY2_metphij2,SUSY2_signal=np.loadtxt("susyfulldelphes2.csv", unpack=True,skiprows=1)
SUSY3_ptj1,SUSY3_ptj2,SUSY3_etaj1,SUSY3_etaj2,SUSY3_phij,SUSY3_MET,SUSY3_met_phi,SUSY3_metphij1,SUSY3_metphij2,SUSY3_signal=np.loadtxt("susyfulldelphes3.csv", unpack=True,skiprows=1)
