...
plt.figure()
plt.plot(ALPbg_rate, ALPsig_rate, lw=2, label='ALP, AUC = %0.2f)'%(ALProc_auc))
plt.plot(EFTbg_rate, EFTsig_rate, lw=2, label='EFT, AUC = %0.2F'%(EFTroc_auc))
plt.plot(SUSY1bg_rate, SUSY1sig_rate, lw=2, label='SUSY1, AUC = %0.2f)'%(SUSY1roc_auc))
plt.plot(SUSY2bg_rate, SUSY2sig_rate, lw=2, label='SUSY2, AUC = %0.2f)'%(SUSY2roc_auc))
plt.plot(SUSY3bg_rate, SUSY3sig_rate, lw=2, label='SUSY3, AUC = %0.2f)'%(SUSY3roc_auc))
