...
ax.plot(fpr1,tpr1,lw=2,color='red', label=r'ALPs, AUC=0.57')
ax.plot(fpr2,tpr2,lw=2,color='green', label=r'EFT, AUC=0.70')
#ax.plot(fpr3,tpr3,lw=2,color='blue', label=r'SUSY1, AUC=0.61')#WIMP BP1
#ax.plot(fpr4,tpr4,lw=2,color='blue',linestyle='--', label=r'SUSY2, AUC=0.67')#WIMP BP2
#ax.plot(fpr5,tpr5,lw=2,color='blue',linestyle=':', label=r'SUSY3, AUC=0.69')#WIMP BP3

ax.plot(fpr3,tpr3,lw=2,color='orange', label=r'SUSY1, AUC=0.61')#WIMP BP1
ax.plot(fpr4,tpr4,lw=2,color='blue',label=r'SUSY2, AUC=0.67')#WIMP BP2
ax.plot(fpr5,tpr5,lw=2,color='magenta', label=r'SUSY3, AUC=0.69')#WIMP BP3
