...
#ax.plot(fpr3,tpr3,lw=2,color='blue', label=r'SUSY1, AUC=0.64')#WIMP BP1
#ax.plot(fpr4,tpr4,lw=2,color='blue',linestyle='--', label=r'SUSY2, AUC=0.70')#WIMP BP2
#ax.plot(fpr5,tpr5,lw=2,color='blue',linestyle=':', label=r'SUSY3, AUC=0.72')#WIMP BP3
ax.plot(fpr3,tpr3,lw=2,color='orange', label=r'SUSY1, AUC=0.64')#WIMP BP1
ax.plot(fpr4,tpr4,lw=2,color='blue',label=r'SUSY2, AUC=0.70')#WIMP BP2
ax.plot(fpr5,tpr5,lw=2,color='magenta', label=r'SUSY3, AUC=0.72')#WIMP BP3
...
plab.savefig('ROCsbNN.png', bbox_inches=0,dpi=100)
plt.show()
