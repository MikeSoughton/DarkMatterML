      ...
      real, dimension (1:280105, 1:1) :: Array1,Array2
      real :: distance(280105)
      integer :: i,j,l
      ...
      call read_file (11, 'fpr.txt',280105, 1, Array1)
      call read_file (12, 'tpr.txt',280105, 1, Array2)
...
!      rewind(unit=55) 
      ...
      print*,"distance",otimalpoint,Array1(otimalpoint,1),
     $Array2(otimalpoint,1)
