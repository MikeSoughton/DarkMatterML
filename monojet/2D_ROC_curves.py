...
BG_ptj,BG_etaj,BG_phij,BG_signal=np.loadtxt("smbckgd.csv", unpack=True,skiprows=200001)
ALP_ptj,ALP_etaj,ALP_phij,ALP_signal=np.loadtxt("axion.csv", unpack=True,skiprows=200001)
EFT_ptj,EFT_etaj,EFT_phij,EFT_signal=np.loadtxt("spin1med10.csv", unpack=True,skiprows=200001)
SUSY1_ptj,SUSY1_etaj,SUSY1_phij,SUSY1_signal=np.loadtxt("susy1.csv", unpack=True,skiprows=200001)
SUSY2_ptj,SUSY2_etaj,SUSY2_phij,SUSY2_signal=np.loadtxt("susy2.csv", unpack=True,skiprows=200001)
SUSY3_ptj,SUSY3_etaj,SUSY3_phij,SUSY3_signal=np.loadtxt("susy3.csv", unpack=True,skiprows=200001)
...
plt.savefig('2D_DNN_sig_vs_bg_LO_ROC.png')
...
legend2=plt.legend([r"Parton Level"],loc=5,prop={'size':10},handlelength=0, handletextpad=0,frameon=False)
ax.add_artist(legend1)
plt.savefig('2D_CNN_sig_vs_bg_LO_ROC.png')
