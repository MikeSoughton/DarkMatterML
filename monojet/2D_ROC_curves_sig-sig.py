...
ALP_ptj,ALP_etaj,ALP_phij,ALP_signal=np.loadtxt("axeftsig/axion.csv", unpack=True,skiprows=200001)
EFT_ptj,EFT_etaj,EFT_phij,EFT_signal=np.loadtxt("axeftsig/spin1med10.csv", unpack=True,skiprows=200001)
...
plt.savefig('2D_DNN_SUSY_vs_sig_LO_ROC.png')
...
legend2=plt.legend([r"Parton Level"],loc=5,prop={'size':10},handlelength=0, handletextpad=0,frameon=False)
ax.add_artist(legend1)
plt.savefig('2D_CNN_SUSY_vs_sig_LO_ROC.png')
